...
image::hardware/Functionality.gif[]
...
It is possible to tie common lines together. Here's the assembly I did  on mine in the GIF above:

image::hardware/Internal_Assembly.jpeg[]
